...
export const EditContact = ({ handleEditContact, contactToEdit, index }) => {
    ...
    const handleSubmit = (e) => {
        ...
        handleEditContact(index, formData);
    ...
    return (
        <form onSubmit={handleSubmit} className="h-full items-center flex bg-cyan-500 flex-col px-10 py-4 max-md:px-5">
            <div className="flex flex-col m-auto w-[30vw]">
